...
describe("Testando o signup na camada UserBusiness", () => {
  ...
  test("Deve retornar erro ao receber um nome vazio", () =>
  ...
  test("Deve retornar erro ao receber um email vazio", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(2);
      const userBusiness = new UserBusiness_1.UserBusiness(
        userDatabase,
  ...
  test("Deve retornar erro ao receber uma senha vazia", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(2);
      const userBusiness = new UserBusiness_1.UserBusiness(
        userDatabase,
  ...
  test("Deve retornar erro ao receber um role vazio", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(2);
      const userBusiness = new UserBusiness_1.UserBusiness(
        userDatabase,
  ...
  test("Deve retornar erro 'Invalid email' para um email sem @", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(2);
      const userBusiness = new UserBusiness_1.UserBusiness(
        userDatabase,
  ...
  test("Deve retornar erro 'Invalid password' para uma senha com menos de 6 caracteres", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(2);
      const userBusiness = new UserBusiness_1.UserBusiness(
        userDatabase,
  ...
  test("Deve retornar 'Invalid user role em caso de role que não seja NORMAL ou ADMIN'", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(2);
      try {
        const userBusiness = new UserBusiness_1.UserBusiness(
  ...
  test("Deve retornar token de acesso após criação de usuário", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(3);
      try {
        const userBusiness = new UserBusiness_1.UserBusiness(
