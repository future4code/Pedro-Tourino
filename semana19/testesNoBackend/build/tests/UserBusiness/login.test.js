...
describe("Testando o login na camada de Business", () => {
  ...
  test("Deve retornar erro quando o e-mail está vazio", () =>
  ...
  test("Deve retornar erro quando o usuário não é encontrado", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(3);
  ...
  test("Deve retornar erro quando o usuário passou a senha incorreta", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(4);
      let getUserByEmail = jest.fn((email) => {
  ...
  test("Deve retornar token quando todos os dados estiverem corretos", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      expect.assertions(3);
      let getUserByEmail = jest.fn((email) => {
        return new User_1.User(
