...
let UserController = /** @class */ (() => {
  class UserController {
    signup(req, res) {
      return __awaiter(this, void 0, void 0, function* () {
        try {
          const result = yield UserController.UserBusiness.signup(
            req.body.name,
            req.body.email,
            req.body.password,
            req.body.role
  ...
  UserController.UserBusiness = new UserBusiness_1.UserBusiness(
    new UserDatabase_1.UserDatabase(),
    new idGenerator_1.IdGenerator(),
    new hashGenerator_1.HashGenerator(),
    new tokenGenerator_1.TokenGenerator()
  );
